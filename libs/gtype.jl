...
# Generate code that declares struct for abstract objects
...
# Generate a function for this type that calls the library to find the GType
...
# Generate code that declares struct(s) and a couple of constructors for instantiable objects
