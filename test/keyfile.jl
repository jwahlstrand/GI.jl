...
for i=1:1
    ...
    @test bool_list == GLib.get_boolean_list(kf,"group","bool_list2")[1]

    int_list = [12,13,14,5]
    GLib.set_integer_list(kf,"group","integer_list2",int_list)
    @test GLib.get_integer_list(kf,"group","integer_list2")[1]==int_list

    double_list = [3,6,3,8]
    GLib.set_double_list(kf,"group","double_list2",double_list)
    @test GLib.get_double_list(kf,"group","double_list2")[1]==double_list
